...
// *********************************************************************//
  CoDirectControl = class
    ...
    class function CreateRemote(const MachineName: string): IDirectControl;
  end;
...
// *********************************************************************//
  CoDirectContainer = class
    ...
    class function CreateRemote(const MachineName: string): IDirectContainer;
  end;
...
// *********************************************************************//
  CoRadioView = class
    ...
    class function CreateRemote(const MachineName: string): IRadioView;
  end;
...
// *********************************************************************//
  CoAsyncPProt = class
    ...
    class function CreateRemote(const MachineName: string): IAsyncPProt;
  end;
...
// *********************************************************************//
  CoAsyncMHandler = class
    ...
    class function CreateRemote(const MachineName: string): IAsyncMHandler;
  end;
...
// *********************************************************************//
  CoRadioPlayer = class
    ...
    class function CreateRemote(const MachineName: string): IRadioPlayer;
  end;
...
// *********************************************************************//
  CoRadioBand = class
    ...
    class function CreateRemote(const MachineName: string): IRadioBand;
  end;
...
class function CoDirectControl.CreateRemote(const MachineName: string): IDirectControl;
begin
...
class function CoDirectContainer.CreateRemote(const MachineName: string): IDirectContainer;
begin
...
class function CoRadioView.CreateRemote(const MachineName: string): IRadioView;
begin
...
class function CoppDShowNet.CreateRemote(const MachineName: string): IUnknown;
begin
...
class function CoppDShowPlay.CreateRemote(const MachineName: string): IUnknown;
begin
...
class function CoppDSMeta.CreateRemote(const MachineName: string): IUnknown;
begin
...
class function CoppDSCnnl.CreateRemote(const MachineName: string): IUnknown;
begin
...
class function CoppDSClip.CreateRemote(const MachineName: string): IUnknown;
begin
...
class function CoppDSDetl.CreateRemote(const MachineName: string): IUnknown;
begin
...
class function CoppDSApp.CreateRemote(const MachineName: string): IUnknown;
begin
...
class function CoppDSPropAdv.CreateRemote(const MachineName: string): IUnknown;
begin
...
class function CoppDSView.CreateRemote(const MachineName: string): IUnknown;
begin
...
class function CoppDSOAdv.CreateRemote(const MachineName: string): IUnknown;
begin
...
class function CoAsyncPProt.CreateRemote(const MachineName: string): IAsyncPProt;
begin
...
class function CoAsyncMHandler.CreateRemote(const MachineName: string): IAsyncMHandler;
begin
...
class function CoRadioPlayer.CreateRemote(const MachineName: string): IRadioPlayer;
begin
...
class function CoRadioServer.CreateRemote(const MachineName: string): IRadioPlayer;
begin
...
class function CoRadioBand.CreateRemote(const MachineName: string): IRadioBand;
begin
...
class function CoppDSFile.CreateRemote(const MachineName: string): IUnknown;
begin
